...
class TestPreviewPage(BaseTest):
    ...
    def test_event_preview_content(self):
        ...
        self.events_list_page.create_event_btn_is_visible()
        self.events_list_page.click_create_event_btn()
        self.events_list_page.fill_title_field(EVENT_NAME)
        self.events_list_page.fill_description_field(EVENT_DESCRIPTION)
        self.events_list_page.select_current_date()
        self.events_list_page.fill_duration_field(EVENT_DURATION)
        self.events_list_page.select_category_field()
        self.events_list_page.select_category_option()
        self.events_list_page.select_language_field()
        self.events_list_page.select_language_option()
        self.events_list_page.select_price_field()
        self.events_list_page.select_price_type()
        self.events_list_page.fill_visit_cost_field(EVENT_COST)
        self.events_list_page.fill_location_field(EVENT_LOCATION)
        self.events_list_page.upload_image_field(str(IMAGE_PATH))
        self.events_list_page.click_save_event_btn()
    ...
    def test_event_preview_content_in_new_window(self):
        ...
        events_list_new = self.events_list_page.__class__(new_page)
